...
export const metadata: Metadata = {
  ...
  keywords: "Dr. Rajkumar Sangiri, Consultant Physician, MD General Medicine, Bankura Doctor, Meditrust Medicare Bankura, Sristi Diagnostic centre, Bankura Nursing home, Keerteni Medipoint, Blood Sugar, Blood Pressure, Thyroid, Gastro problem, Respiratory Problem",
  openGraph: {
    title: "Dr. Rajkumar Sangiri | Consultant Physician | Bankura",
